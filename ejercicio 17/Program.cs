using System.Timers;
//ya lo habia hecho en el ejercicio 10 cumple con agregar, mostrar y eliminar
void Presionar()
{
    Console.WriteLine();
...
do
{
    ...
    switch (opcion)
    {
        ...
        case "3":
            ...
            {
                prodructos.Remove(idP);
                Console.WriteLine("el producto a sido eliminado con exito");
            }
            else
            {
